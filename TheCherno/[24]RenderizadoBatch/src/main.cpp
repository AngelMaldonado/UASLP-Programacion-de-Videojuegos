/**
 * @brief El renderizado batch o renderizado por lotes, trata basicamente de
 * introducir todas las geometrias y datos para renderizar en un solo VB (vertex buffer object)
 * para solamente tener que llamar la funcion de dibujado una sola vez, ya que el VB
 * ya tiene conocimiento de toda la geometria y datos para dibujar. De esta manera se
 * reduce mucho el coste de ejecucion del programa ya que se evita la necesidad de llamar
 * la funcioin de dibujado una vez por cada geometria.
 * 
 * El renderizado batch implica que el VB tenga que ser DINAMICO, para poder actualizar su
 * informacion constantemente, ya sea para introducir mas geometrias o modificar las
 * propiedades (color, posicion, rotacion, etc) de las que ya estan.
 * 
 * @author @AngelMaldonado
 * @file main(respaldo).cpp
