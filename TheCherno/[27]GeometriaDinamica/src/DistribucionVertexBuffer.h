...
public:
    ...
    /**
     * @brief Plantilla para tipos especificos
     * @tparam T 
     * @param cuenta Cuantos datos del tipo especifico hay en el VBO
     */
    template<typename T>
    ...
    // /**
    //  * @brief Plantilla para tipos predefinidos (se definen en DistribucionVertexBuffer.h)
    //  * 
    //  * @tparam T 
    //  */
    // template<typename T>
...
// template<>
// inline void DistribucionVertexBuffer::Push<Vertice>()
// {
//     Push<float>(3);         // Posicion
//     Push<float>(4);         // Color
//     Push<float>(2);         // Coordenadas de textura
//     Push<unsigned int>(1);  // ID de textura
// }
