...
public:
    ...
    /**
     * @brief Funcion para establecer un vector de enteros uniforme
     * 
     * @param nombreUniforme Nombre de la variable uniforme
     * @param valores Vector de enteros con los valores
     * @return Reserva un espacio en memoria para la variable uniforme
     */
    void EstableceUniforme1iv(const std::string& nombreUniforme, const std::vector<int>& valores);
     ...
     * @return Reserva un espacio en memoria para la variable uniforme
     */
    void EstableceUniformeMat4f(const std::string& nombreUniforme, const glm::mat4& matriz);
private:
    /**
